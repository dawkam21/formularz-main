        ...
        try {
          ...
          if ($con->connect_errno != 0) {
            throw new Exception(mysqli_connect_errno());
              ...
              $sql1 = "SELECT id, fldFirstName, fldLastName, fldEmail, fldBirthDate, fldSex FROM tbl_users ORDER BY id DESC LIMIT 15";
              ...
              if ($result->num_rows > 0) {
                ...
                echo "<tbody>
                <tr class='mainTr'>
                <th style='padding: 2px; width: 8%;'><a href='sortById.php'>id <i class='fa fa-sort-down'></i></th>
                ...
                <th style='width: 13%;'><a href='sortByBirthDateAsc.php'>Data urodzenia <i class='fa fa-sort-down'></i></a></th>
